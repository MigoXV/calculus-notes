...
例1 计算极限 $\lim _{x \rightarrow \infty}\left[\frac{a_{1}^{\frac{1}{x}}+a_{2}^{\frac{1}{x}}+\cdots+a_{n}^{\frac{1}{x}}}{n}\right]^{n x},\left(a_{1}, a_{2}, \cdots, a_{n}>0\right)$ ．例2 计算极限 $\lim _{x \rightarrow+\infty}\left(\sqrt[3]{x^{3}+3 x^{2}}-\sqrt[4]{x^{4}-2 x^{3}}\right)$ ．
