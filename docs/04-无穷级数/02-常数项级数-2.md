...
（2）$\because \lim _{n \rightarrow \infty} \frac{u_{n+1}}{u_{n}}=\lim _{n \rightarrow \infty} \frac{(n+1)!}{10^{n+1}} \cdot \frac{\mathbf{1 0}^{n}}{n!}=\lim _{n \rightarrow \infty} \frac{n+1}{10}=\infty>1$ ，由正项级数的比值审敛法知原级数 $\sum_{n=1}^{\infty} \frac{n!}{10^{n}}$ 发散。
...
由正项级数的比较审敛法知原级数 $\sum_{n=1}^{\infty} \frac{1}{2 n \cdot(2 n-1)}$ 收敛。
说明：比值审敛法一般适用于级数通项
...
$\because \lim _{n \rightarrow \infty} \frac{u_{n+1}}{u_{n}}=\lim _{n \rightarrow \infty} \frac{|\alpha|^{n+1}}{(n+1)!} \frac{n!}{|\alpha|^{n}}=\lim _{n \rightarrow \infty} \frac{|\alpha|}{n+1}=0<1$,
...
故原级数绝对收敛。
（2）$\sum_{n=1}^{\infty} \frac{n \cdot \cos \frac{2 n \pi}{3}}{2^{n}}$ ；
解 考虑 $\sum_{n=1}^{\infty} \frac{n \cdot\left|\cos \frac{2 n \pi}{3}\right|}{2^{n}}$ ，且 $\frac{\boldsymbol{n \cdot | \cos \frac { \mathbf { 2 n } \pi } { \mathbf { 3 } } |}}{\mathbf{2}^{\boldsymbol{n}}} \leq \frac{\boldsymbol{n}}{\mathbf{2}^{\boldsymbol{n}}}$ ，
...
对任意项级数，先用正项级数的审敛法判断它是否绝对收敛，否则，再用莱布尼兹审敛法判断它是否收敛，若收敛，则知它是条件收敛。
