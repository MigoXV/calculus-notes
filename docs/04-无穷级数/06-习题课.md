...
$$
\begin{aligned}
& \quad \text { 设 } \sum_{n=0}^{\infty} a_{n} x^{n} \text { 和 } \sum_{n=0}^{\infty} b_{n} x^{n} \text { 的收敛半径各为 } R_{1} \text { 和 } R_{2} \text {, } \\
...
除 $\frac{\sum_{n=0}^{\infty} a_{n} x^{n}}{\sum_{n=0}^{\infty} b_{n} x^{n}}=\sum_{n=0}^{\infty} c_{n} x^{n}$ ．（收敛域内 $\sum_{n=0}^{\infty} b_{n} x^{n} \neq 0$ ）
...
可 幂级数 $\sum_{n=0}^{\infty} a_{n} x^{n}$ 的和函数 $s(x)$ 在收敛区间性 $(-\boldsymbol{R}, \boldsymbol{R})$ 内可导，并可逐项求导任意次。
...
可积 幂级数 $\sum_{n=0}^{\infty} a_{n} x^{n}$ 的和函数 $s(x)$ 在收敛区间性 $(-R, R)$ 内可积，且对 $\forall x \in(-R, R)$ 可逐项积分．
...
例1 求 $\frac{x}{1 \cdot 3}+\frac{x^{2}}{2 \cdot 3^{2}}+\frac{x^{3}}{3 \cdot 3^{3}}+\cdots+\frac{x^{n}}{n \cdot 3^{n}}+\cdots$ 的和函数。

例2 求 $\sum_{n=1}^{\infty} n x^{n-1}$ 的收敛域与和函数，并求 $\sum_{n=1}^{\infty} \frac{n}{2^{n-1}}$ ．

例3 求 $\sum_{n=1}^{\infty} \frac{2 n-1}{2^{n}} x^{2 n-2}$ 的收敛域与和函数，并求 $\sum_{n=2}^{\infty} \frac{2 n-1}{2^{n}}$ ．例 4 求 $\sum_{n=1}^{\infty} \frac{n(n+1)}{2^{n}}$ 的和．
...
当 $x=-3$ 时，原幂级数成为 $\sum_{n=1}^{\infty} \frac{(-1)^{n}}{n}$ ，收敛。
∴ 收敛域为 $[-\mathbf{3 , 3})$ ．
...
例 2 求 $\sum_{n=1}^{\infty} n x^{n-1}$ 的收敛域与和函数，并求 $\sum_{n=1}^{\infty} \frac{n}{2^{n-1}}$ ．
解
...
例 3 求 $\sum_{n=1}^{\infty} \frac{2 n-1}{2^{n}} x^{2 n-2}$ 的收敛域与和函数，并求 $\sum_{n=2}^{\infty} \frac{2 n-1}{2^{n}}$ ．
...
解 考虑级数 $\sum_{n=1}^{\infty} n(n+1) x^{n}$ ，收敛区间 $(-1,1)$ ，
...
例1 判断级数发散性 ：$\sum_{n=1}^{\infty} \frac{n^{n+\frac{1}{n}}}{\left(n+\frac{1}{n}\right)^{n}}$ ；
例2 判断级数发散性：$\sum_{n=1}^{\infty} \frac{\ln (n+2)}{\left(a+\frac{1}{n}\right)^{n}} \quad(a>0)$ ．
例3 判断级数 $\sum_{n=1}^{\infty} \frac{(-1)^{n}}{n-\ln n}$ 是否收敛？如果收敛，是条件收敛还是绝对收敛？

例4 讨论级数 $1-\frac{1}{2^{\alpha}}+\frac{1}{3}-\frac{1}{4^{\alpha}}+\frac{1}{5}-\frac{1}{6^{\alpha}}+\cdots$ 的发散性．如果收敛，说明是条件收敛还是绝对收敛。

例 5 求级数 $\sum_{n=0}^{\infty}(n+1)(x-1)^{n}$ 收敛域及和函数．

例1 判断级数发散性 ：$\sum_{n=1}^{\infty} \frac{n^{n+1}}{\left(n+\frac{1}{n}\right)^{n}}$ ；
...
例4 讨论级数 $1-\frac{1}{2^{\alpha}}+\frac{1}{3}-\frac{1}{4^{\alpha}}+\frac{1}{5}-\frac{1}{6^{\alpha}}+\cdots$ 的发散性．
如果收敛，说明是条件收敛还是绝对收敛。
解（1）当 $\alpha=1$ 时，原级数为 $\sum_{n=1}^{\infty}(-1)^{n} \frac{1}{n}$ ，它为条件收敛。
（2）当 $\alpha>1$ 时，$\sum_{n=1}^{\infty} \frac{1}{n^{\alpha}}$ 收敛，$\sum_{n=1}^{\infty} \frac{1}{(2 n)^{\alpha}}$ 收敛，而 $\sum_{n=1}^{\infty} \frac{1}{2 n+1}$ 发散，故原级数发散。
...
故由比较审敛法的极限 形式知加括号的级数发 散，故原级数发散。

例 5 求级数 $\sum_{n=0}^{\infty}(n+1)(x-1)^{n}$ 收敛域及和函数．
解 $\because \sum_{n=0}^{\infty}(n+1)(x-1)^{n}$ 的收敛半径为 $R=1$ ，
